...
#+begin_src emacs-lisp
  (setq treesit-language-source-alist
        '((typescript "https://github.com/tree-sitter/tree-sitter-typescript" "v0.23.2" "typescript/src")
          ...
          (rust "https://github.com/tree-sitter/tree-sitter-typescript" "v0.23.0")))
#+end_src
...
+LSP mode seems to work better with omnisharp, so we'll try both.+ No need for omnisharp right now
so we'll stick with eglot.
