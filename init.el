;;;; Custom settings - loaded from separate file
...
;; Reference: http://www.emacswiki.org/emacs/LoadPath
...
;; Reference: http://www.masteringemacs.org/articles/2010/11/14/disabling-prompts-emacs/
(fset 'yes-or-no-p 'y-or-n-p)

;; Delete/type over selection
...
(global-set-key (kbd "<f9>") 're-builder)
...
(setq picture-directory "~/Pictures")
...
;; Slightly faster pop-to-mark command
...
;;; Lorem ipsum text
;;;
;;; Reference: http://www.emacswiki.org/emacs/LoremIpsum
...
(defun web-lookup-function-jquery ()
  "Look up the word under the cursor in the jQuery API documentation at api.jquery.com.
This command switches to the browser"
  (interactive)
  (web-lookup-function "http://api.jquery.com/"))
